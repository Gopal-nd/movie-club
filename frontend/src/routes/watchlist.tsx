...
function WatchlistPage() {
  const { user, isAuthenticated, watchlist, removeFromWatchlist } = useAppStore()
        ...
        {watchlist.length === 0 ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Watchlist Statistics</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600 mb-2">
                    {watchlist.filter(item => item.movie?.vote_average && item.movie.vote_average >= 7).length}
                  </div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-600 mb-2">
                    {new Set(watchlist.map(item => new Date(item.movie?.release_date || '').getFullYear())).size}
                  </div>
